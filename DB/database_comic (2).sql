...
INSERT INTO `chapter` (`id`, `index_chapter`, `name`, `comic_id`) VALUES
	(1, 1, 'bat dau', 1),
	(2, 2, 'giua tran', 1),
	(3, 3, 'ket thuc', 1);
...
INSERT INTO `comics` (`id`, `name`, `description`, `image`, `cover_image`, `status`, `others_name`, `country`, `release_date`) VALUES
	(1, 'one piece', NULL, 'abc.png', NULL, NULL, NULL, NULL, NULL),
	(2, 'optimis', 'hay chon gia dung', 'https://cdn.vox-cdn.com/thumbor/oylb3MGb1jQk3LOP2N3c4eaW-dg=/1400x1400/filters:format(jpeg)/cdn.vox-cdn.com/uploads/chorus_asset/file/24390847/last_knight_optimus.jpeg', NULL, 1, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `comic_genre` (
  ...
  CONSTRAINT `comic_genre_ibfk_2` FOREIGN KEY (`genre_id`) REFERENCES `genre` (`id`)
...
CREATE TABLE IF NOT EXISTS `image` (
  ...
  CONSTRAINT `image_ibfk_1` FOREIGN KEY (`chapter_id`) REFERENCES `chapter` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table comics.image: ~9 rows (approximately)
INSERT INTO `image` (`id`, `file`, `index_image`, `chapter_id`) VALUES
